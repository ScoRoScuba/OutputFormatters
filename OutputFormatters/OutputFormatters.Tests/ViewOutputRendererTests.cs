...
namespace OutputFormatters.Tests
{
    public class ViewOutputRendererTests
    {
        ...
        public void View_Formatter_Outputs_AllDataCorrectly()
        {
            ...
            result.Should().Contain($"View: FooView{Environment.NewLine}\tBar of type int{Environment.NewLine}\tBob of type string{Environment.NewLine}\tTable: FooTable{Environment.NewLine}\tBar1 of type int{Environment.NewLine}\tBob1 of type string");
        }
    }
}
